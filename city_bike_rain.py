...
# Load weather data
weather_df = pd.read_html('weather.html', parse_dates=['date'])[0][['date', 'mmPrecipitation']]
...
# Plot results
ax = resampled_trips.loc["2018-9-01 04:00:00":"2018-09-30 23:59:59"].plot(y=['Counter'])
